...
def update_worksheet(data, worksheet):
    """
    Receives a  list of intengers to be inserted into a worksheet
...
def calculate_surplus_data(sales_row):
    ...
    The surplis is define as the  sales  figure subtracted from  the stock:
...
def main():
    ...
    sales_collumns = get_last5_entries_sales()
